...
function updateProfile(userId, updateData) {
    return __awaiter(this, void 0, void 0, function () {
        var imagen, updateDataComplete;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!updateData.pictureURL) return [3 /*break*/, 3];
                    return [4 /*yield*/, cloudinary_1.cloudinary.uploader.upload(updateData.pictureURL, {
                            resource_type: "image",
                ...
                case 1:
                    ...
                    return [4 /*yield*/, user_1.User.update(updateDataComplete, {
                            where: {
                                id: userId
                            }
                        })];
                case 2:
                    _a.sent();
                    return [2 /*return*/, updateDataComplete];
                case 3:
